...
import { getProductById, products, reviews as allReviews } from "@/data/products";
      ...
      <div className="container py-4 md:py-8">
          ...
          <div>
            <div className="relative aspect-[4/5] overflow-hidden rounded-lg bg-muted mb-3">
              ...
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center"
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 h-8 w-8 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center"
            ...
            <div className="flex gap-2 overflow-x-auto scrollbar-hide">
              {product.images.map((img, i) => (
                <button
                  ...
                  className={cn(
                    "w-16 h-20 rounded overflow-hidden border-2 flex-shrink-0 transition-colors",
                ...
                {product.sizes.map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "h-10 w-12 rounded-lg border text-sm font-medium transition-all font-body",
                ...
                {product.colors.map((c, i) => (
                  <button
                    ...
                    className={cn(
                      ...
                      i === selectedColor ? "border-primary ring-2 ring-primary/30 scale-110" : "border-border"
                    )}
        ...
        {productReviews.length > 0 && (
          <section className="mt-12">
              ...
              {(showAllReviews ? productReviews : productReviews.slice(0, 3)).map((r) => (
                <div key={r.id} className="p-4 rounded-lg border border-border">
                  ...
                  <div className="flex gap-0.5 mb-1">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star key={s} className={cn("h-3 w-3", s <= r.rating ? "fill-accent text-accent" : "text-border")} />
                    ))}
                  </div>
            ...
            {productReviews.length > 3 && !showAllReviews && (
          ...
          <section className="mt-12">
            ...
            <div className="flex gap-4 overflow-x-auto scrollbar-hide snap-x snap-mandatory pb-4 md:grid md:grid-cols-4 md:gap-6">
              {relatedProducts.map((p) => (
                <div key={p.id} className="min-w-[160px] md:min-w-0 snap-start">
